...
describe('MyTransfersCtrl', function() {
    var controllerFactory, scope, accountService;

    function createController() {
        return controllerFactory('MyTransfersCtrl', {
            $scope: scope,
    ...
    // Test variable transfersList value
    it('should have variable transfersList not null', function(){
        createController();
        dump("[myTransfersCtrlTest] Test variable transfersList value not null");
        expect(scope.transfersList).not.toBe('null');
    });
});