...
describe('MyMessagesCtrl', function() {
    var controllerFactory, scope, messageService;

    function createController() {
        return controllerFactory('MyMessagesCtrl', {
            $scope: scope,
    ...
    // Test variable messageList value
    it('should have variable messageList not null', function(){
        createController();
        dump("[myMessageCtrlTest] Test variable messageList value not null");
        expect(scope.messageList).not.toBe('null');
    });
