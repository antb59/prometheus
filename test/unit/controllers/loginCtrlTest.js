...
describe('LoginCtrl', function() {
    ...
    // Test set of login function
    it('should set login function', function() {
        createController();
        dump("[LoginCtrlTest] Test set of login function");
        expect(scope.login).toBeDefined();
    });

    // Test set of idSaveChange function
    it('should set idSaveChange function', function() {
        createController();
        dump("[LoginCtrlTest] Test set of idSaveChange function");
        expect(scope.idSaveChange).toBeDefined();
    });
});